export const useStory = () => {
  const story = [
    ...
    },
    {
      ...
      image: "/majorat-3.webp",
      imgText:
        "Ne-am distrat la toate majoratele posibile, care au fost foarte multe. 💖 Mai tii minte pozele noastre boho? 😂",
    },
    {
      subtitle: "Capitolul IV - Am crescut in doi",
      image: "/majorat-noi.webp",
      imgText:
        "Dar cel mai mult ne-am distrat la majoratele noastre. 💖 Pana si primul pas inspre maturitate l-am facut impreuna. 😍",
    },
    {
      subtitle: "Capitolul IV - Am crescut in doi",
      image: "/spital-noi.webp",
      imgText:
        "Ne-am distrat, dar nu am uitat sa ne ocupam si de lucrurile serioase. Avem in poza asta doi viitori doctori: tu si probabil cineva din spatele meu. 😂",
    },
    {
      subtitle: "Capitolul IV - Am crescut in doi",
      image: "/banchet-noi.webp",
      imgText:
    ...
    {
      subtitle: "Capitolul V - Inapoi impreuna",
      image: "/absolvire-dana.webp",
      imgText:
        'Am celebrat si pasii "gresiti", dar mai ales pe cei buni. 💖 Si sa ma simt putin medic, mi-ai oferit cateva minute medalia ta. 😂',
    },
    {
      subtitle: "Capitolul V - Inapoi impreuna",
      image: "/emilut.webp",
      imgText:
        'Am ajuns sa avem si prima noastra casuta impreuna. 💖 Never forget Emilut si garsoniera lui "cocheta". 😂',
    },
    {
      subtitle: "Capitolul VI - Our journeys 🛫",
      image: "/noi-roma.webp",
      imgText:
        "Iar in noua noastra etapa am inceput sa calatorim in lume impreuna. 🌍 Si chiar daca am cam alergat prin Roma, nu cred ca o sa uitam prima carbonara adevarata. 😂🍝",
    },
    {
      subtitle: "Capitolul VI - Our journeys 🛫",
      image: "/intoarcere-china.webp",
      imgText:
        "Ne-am demonstrat ca dragostea noastra e la fel de puternica, chiar si la 8000 km departare. 💖 Abia asteptam sa te vad si sa te strang in brate, chiar daca eram pe drum de peste 24 de ore. 😂",
    },
    {
      subtitle: "Capitolul VI - Our journeys 🛫",
      image: "/noi-milano.webp",
      imgText:
        "Si am continuat sa exploram lumea, mentalitati diferite, culturi noi. 💖 Mamma mia, grande Italia. 😂",
    },
    {
      subtitle: "Capitolul VI - Our journeys 🛫",
      image: "/noi-germania.webp",
      imgText:
        "In fiecare loc, sa explorez si sa descopar cu tine era ce ne facea vacanta frumoasa. 💖 Ich liebe dich! Scuze ca suna ca o injuratura. 😂",
    },
    {
      subtitle: "Capitolul VI - Our journeys 🛫",
      image: "/noi-foci.webp",
      imgText:
        "Si fiecare peisaj care ne uimea, era mai frumos pentru ca eram in prezenta ta. 💖 Aici am vrut sa pun ceva in limba focilor, dar n-am gasit nimic. 😂",
    },
    {
      subtitle: "Capitolul VI - Our journeys 🛫",
      image: "/noi-copenhaga.webp",
      imgText:
        "Asa am ajuns si in orasul in care speram ca, intr-o zi, vom ajunge sa locuim. 💖 Sau macar in aceeasi tara. 😂 Dar ar mai fi ceva ...",
    },
  ];
